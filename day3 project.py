...
if choice1 == "left":
    ...
    if choice2 ==  "wait":
        choice3 = input("You arrive at the island unharmed. There is an island in the There is a house with 3 doors. One red, One yellow and one blue. Which colour do you choose?").lower()
        if choice3 == "red":
            ...
            print("Yoy choose a door that doesn't exist. Game over.")
    else:
